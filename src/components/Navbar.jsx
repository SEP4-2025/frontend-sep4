...
function Navbar() {
  ...
  return (
    <div className="w-64 bg-navbar-color text-white flex flex-col items-center p-4 min-h-full">
      ...
      <Link to="/dashboard" className={`flex flex-row w-full justify-start pl-3 py-2 ${isActive('/dashboard') ? 'bg-green-100' : 'hover:bg-green-50'}`}>
        <img src={homeIcon} alt="Dashboard-icon" width="20" height="20" />
      ...
      <Link to="/sensor-view" className={`flex flex-row w-full justify-start pl-3 py-2 ${isActive('/sensor-view') ? 'bg-green-100' : 'hover:bg-green-50'}`}>
        <img src={sensorIcon} alt="Sensor-icon" width="20" height="20" />
      ...
      <Link to="/gallery" className={`flex flex-row w-full justify-start pl-3 py-2 ${isActive('/gallery') ? 'bg-green-100' : 'hover:bg-green-50'}`}>
        <img src={galleryIcon} alt="Gallery-icon" width="20" height="20" />
      ...
      <Link to="/about" className={`flex flex-row w-full justify-start pl-3 py-2 ${isActive('/about') ? 'bg-green-100' : 'hover:bg-green-50'}`}>
        <img src={aboutIcon} alt="About-us-icon" width="20" height="20" />
      ...
      <button
        ...
        className="w-full text-left pl-3 py-2 hover:bg-red-100 mt-auto text-red-700 font-medium"
      >
        <p className="Navbar-content self-start p-2">Logout</p>
      </button>
